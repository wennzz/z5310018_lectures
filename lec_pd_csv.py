...
print(as_df) # headers are unnamed as 0
...
# print(ser_no_name)## Read it back

as_df = pd.read_csv(QAN_CLOSE_CSV, header=None, index_col=0) # 0 as index, 1 as column header
print(as_df)
#
